...
function buildReveal() {
  ...
  pandoc -w revealjs --template $ORIGIN/templates/reveal-slides-template$2.html --number-sections --email-obfuscation=none -o ../export/$1-reveal-slides$2.html $1.md
...
function exportMdFile() {
  ...
  buildReveal $1
  buildRevealPdf $1
  buildReveal $1 -alternative
  buildRevealPdf $1 -alternative
  #buildDeck $1
  buildHtml $1
  #buildDocx $1
  #buildPdf $1
